...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Inventa Soft | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>INVENTA</b>SOFT</span>
        </a>
...
<div class="user-panel">
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright &copy; 2017 <a href="#" target="_blank">Marcos De Andrade</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a href="./">INVENTA<b>SOFT</b></a>
      </div><!-- /.login-logo -->
